...
describe('JSON RPC', function () {
    var endpointExtraSlash = 'http://localhost/';
    var endpoint = 'http://localhost';
    var fetchMock = fetch;
    var jsonRpc;
    beforeEach(function () {
        fetchMock.resetMocks();
        jsonRpc = new eosjs_jsonrpc_1.JsonRpc(endpointExtraSlash);
    });
    ...
    it('calls get_block_info', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, blockNum, expReturn, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expPath = '/v1/chain/get_block_info';
                    blockNum = 1234;
                    expReturn = { data: '12345' };
                    expParams = {
                        body: JSON.stringify({
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4 /*yield*/, jsonRpc.get_block_info(blockNum)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
    ...
    it('calls get_scheduled_transactions', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, json, lowerBound, limit, expReturn, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('calls get_table_rows with all params', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, json, code, scope, table, lowerBound, upperBound, limit, indexPosition, keyType, expReturn, reverse, showPayer, callParams, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('calls get_table_rows with default params', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, json, code, scope, table, lowerBound, upperBound, limit, indexPosition, keyType, reverse, showPayer, expReturn, callParams, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expPath = '/v1/chain/get_table_rows';
    ...
    it('calls get_kv_table_rows with all params', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, json, code, table, indexName, encodeType, indexValue, lowerBound, upperBound, limit, reverse, showPayer, expReturn, callParams, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expPath = '/v1/chain/get_kv_table_rows';
                    json = false;
                    code = 'morse';
                    table = 'coffee';
                    indexName = 'type';
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4 /*yield*/, jsonRpc.get_kv_table_rows(callParams)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
    ...
    it('calls get_kv_table_rows with default params', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, json, code, table, indexName, encodeType, limit, reverse, showPayer, expReturn, callParams, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expPath = '/v1/chain/get_kv_table_rows';
    ...
    it('calls send_transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, signatures, serializedTransaction, limit, expReturn, callParams, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expPath = '/v1/chain/send_transaction';
                    signatures = [
                        'George Washington',
                        'John Hancock',
                        'Abraham Lincoln',
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4 /*yield*/, jsonRpc.send_transaction(callParams)];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
